...
import com.weekendhackers.restaurantmenuapp.utils.PollingCheck;
...
public class TestUtilities extends AndroidTestCase {
    static final String TEST_ITEM_TYPE = "Meat";
...
//    }
    ...
    static ContentValues createItemMeatValues() {
        // Create a new map of values, where column names are the keys
        ContentValues testValues = new ContentValues();
        testValues.put(RestaurantMenuAppContract.ItemEntry.COLUMN_ITEM_TYPE, TEST_ITEM_TYPE);
        testValues.put(RestaurantMenuAppContract.ItemEntry.COLUMN_IMG_PATH, "");
